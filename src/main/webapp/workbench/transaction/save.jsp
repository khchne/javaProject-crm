...
<form class="form-horizontal" role="form" style="position: relative; top: -30px;" id="tranForm"
      action="workbench/transaction/saveTran.do" method="post">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10" style="width: 300px;">
            <input type="text" class="form-control" id="create-activitySrc" value="idea">
            <input type="hidden" name="activitySrc"
                   value="d161f0ecc3ef4270bd52d54349bea99a">
        </div>
    </div>
    ...
    <div class="form-group">
        <label for="create-contactsName" class="col-sm-2 control-label">联系人名称&nbsp;&nbsp;<a href="javascript:void(0);"
                ...
                class="glyphicon glyphicon-search"></span></a></label>
        <div class="col-sm-10" style="width: 300px;">
            <input type="text" class="form-control" id="create-contactsName" value="阿米娅">
            <input type="hidden" name="contactsName" value="67f2c05c35df4105bd27b9138bd9ee7e">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10" style="width: 70%;">
            <textarea class="form-control" rows="3" id="create-contactSummary" name="contactsSummery"></textarea>
        </div>
    </div>
