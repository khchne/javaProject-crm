...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            // 点击创建按钮 从后台取得所有者信息，铺垫下拉框
            $("#addClueBtn").on("click", function () {
                $.ajax({
            ...
            $("#saveClueBtn").on("click", function () {
                $.ajax({
                    ...
                    data: {
                        ...
                        "clueState": $.trim($("#create-status").val()),
                        "clueSource": $.trim($("#create-source").val()),
                        "clueDescription": $.trim($("#create-describe").val()),
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="width: 300px;">
                            <select class="form-control" id="create-status">
                                <option></option>
                                <c:forEach var="clue" items="${clueState}">
            ...
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td><a style="text-decoration: none; cursor: pointer;"
                           onclick="window.location.href='workbench/clue/detail.do?id=87e386c65db143e19d6f2d735d60f317';">李四先生</a>
                    </td>
                    <td>动力节点</td>
                    <td>010-84846003</td>
                    <td>12345678901</td>
